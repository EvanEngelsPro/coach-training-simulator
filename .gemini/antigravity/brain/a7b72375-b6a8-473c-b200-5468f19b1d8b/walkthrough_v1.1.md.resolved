# Coach Training Simulator — V1.1 Updates

## New Features

### 🎯 Targeted Training Mode
Optimize your practice time by focusing only on areas that need improvement.
- **"S'entraîner sur les points faibles"** button in the Training tab.
...
- A **Post-Training Radar** chart appears below your initial assessment after completing a training session.
...
- Initially displays the first 50 segments.
- **"Afficher les 50 suivants"** button allows loading more content.
...
### Dashboard
Radar chart, key metrics, and gap analysis for immediate training focus.

### Interactive Training
AI-powered role-play simulation based on the sales plan.

## How to Test New Features
1. Go to the **Détails** tab.
2. Scroll to the "Résumé du meeting" section to see the structured summary.
3. Scroll to the bottom of the "Transcript" section.
4. Click "Afficher les 50 suivants" to load more segments.
